<#
.SYNOPSIS
    This PowerShell script ensures that the fPromptForPassword = 1 → Forces Remote Desktop (RDP) to always prompt for a password, improving authentication security.
